...
| `CONVERGENCE_STREAK_LIMIT` | `7` | Consecutive `run_agent` iterations with no write before a "stop exploring, make the edit" nudge is injected (fires again every N iterations if the streak continues). `0` disables it |
